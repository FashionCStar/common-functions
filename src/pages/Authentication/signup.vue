      ...
      <div class="q-pa-md text-center" style="margin-top: 67px;">
        ...
        >
          <div class="row justify-between q-col-gutter-md" >
            ...
            <div class="col-12 col-sm-6">
              <!--<q-input outlined required label="Password" type="password" color="cyan-7" v-model="user.password"></q-input>-->
              <base-text-field
                outlined
                required
                color="cyan-7"
            ...
            <div class="col-12 col-sm-6">
              <!--<q-input -->
                ...
                <!--:rules="[val => val === user.password  || 'Password is not match']"></q-input>-->
              <base-text-field
                outlined
                required
                color="cyan-7"
